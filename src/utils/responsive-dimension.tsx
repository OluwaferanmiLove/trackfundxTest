...
//Asuming designs will be in dimensions 414 x 896 (for iPhonex) by default
export const hp = (height: number) => {
  return heightPercentageToDP((height / 844) * 100);
};
...
export const wp = (width: number) => {
  return widthPercentageToDP((width / 390) * 100);
};
